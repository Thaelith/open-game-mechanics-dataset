...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `movement.dash` | movement | draft | medium | yes | yes | strong | strong | Batch 1 improved collision, restoration, UI cooldown, and network correction detail. Maintainer review says ready for later reviewed-status consideration after final relationship direction check. | Keep draft/medium; do not mark reviewed yet. |
...
| `platforming.jump_buffering` | platforming | draft | medium | yes | yes | strong | strong | Batch 1 added animation-lock, cutscene/menu focus, assist-setting, and jump-priority coverage. Maintainer review says ready for later reviewed-status consideration after final priority-order review. | Keep draft/medium; do not mark reviewed yet. |
...
| `combat.reload` | combat | draft | medium | yes | yes | strong | strong | Batch 1 added save/load, reconnect, rollback, staged reload, and predicted UI rejection coverage. Maintainer review says ready for later reviewed-status consideration after non-magazine ammo variant review. | Keep draft/medium; do not mark reviewed yet. |
...
| `ui_ux.cooldown_indicator` | ui_ux | draft | medium | yes | yes | strong | strong | Batch 1 added disabled-ready mismatch, authority correction, charge-pip, and recycled-widget coverage. Maintainer review says ready for later reviewed-status consideration after accessibility layout/color review. | Keep draft/medium; do not mark reviewed yet. |
...
| `time.time_rewind` | time | draft | medium | yes | yes | strong | strong | Batch 1 added reward/quest/narrative, projectile, AI, RNG, and save/checkpoint coverage. Maintainer review and dedicated checklist both keep it in architecture-review status. | Not ready for reviewed status; keep draft/medium. |
